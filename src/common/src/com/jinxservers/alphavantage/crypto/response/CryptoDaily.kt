...
@Serializable(with = CryptoDailySerializer::class)
public class CryptoDaily(
    @SerialName("Meta Data")
    public val metaData: CryptoDailyMetaData,
...
@Serializable
public class CryptoDailyMetaData(
