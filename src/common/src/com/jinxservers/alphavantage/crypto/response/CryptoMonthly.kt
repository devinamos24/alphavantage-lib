...
import com.jinxservers.alphavantage.crypto.CryptoMonthlySerializer
import com.jinxservers.alphavantage.util.CentralInstantAsStringSerializer
import kotlinx.datetime.Instant
import kotlinx.serialization.SerialName
import kotlinx.serialization.Serializable

@Serializable(with = CryptoMonthlySerializer::class)
public class CryptoMonthly(
    @SerialName("Meta Data")
    public val metaData: CryptoMonthlyMetaData,
    @SerialName("Time Series (Digital Currency Monthly)")
    public val cryptoUnits: List<CryptoUnit>
) : Comparable<CryptoMonthly> {

    override fun toString(): String {
        return "CryptoMonthly(metaData=$metaData, CryptoUnits=$cryptoUnits)"
    }

    override fun compareTo(other: CryptoMonthly): Int {
...
@Serializable
public class CryptoMonthlyMetaData(
...
) : Comparable<CryptoMonthlyMetaData> {

    override fun toString(): String {
        return "CryptoMonthlyMetaData(information='$information', digitalCurrencyCode='$digitalCurrencyCode', digitalCurrencyName='$digitalCurrencyName', marketCode='$marketCode', marketName='$marketName', lastRefreshed=$lastRefreshed, timeZone='$timeZone')"
    }

    override fun compareTo(other: CryptoMonthlyMetaData): Int {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as CryptoMonthlyMetaData
